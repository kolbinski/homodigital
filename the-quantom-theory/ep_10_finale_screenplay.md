...
**CROSS (V.O.)**
None. I crossed out the last one twenty minutes ago. In 's laboratory. Using his red marker, which I did not ask permission to use, but the circumstance seemed to warrant it.
...
**INTERCUT: THE PHONE CALL CONTINUES**

The following sequence intercuts the Maciej-Cross conversation with the other characters, showing the broader convergence happening simultaneously.

---

**INT. OLA'S APARTMENT — WARSAW — NIGHT**

Ola at her workstation, running new simulations. Her screens show the R trajectory data — the growing curve — mapped against Maciej's RFC predictions.

She's extending the model. Not just analyzing Maciej's data — running her own simulations that project RFC into artificial substrates. What would R look like in a system with different architecture? Different scale? Different substrate?

On her screen: a simulation result. A predicted R curve for a hypothetical AI system. The curve rises — logarithmically, just like Maciej's data. But it doesn't plateau where she expected.
...
Same result. The predicted R for an AI substrate exceeds the predicted R for a biological substrate — not because the AI is "more conscious," but because the weight profile shifts toward information integration (w₃), which in this architecture has no biological ceiling.
...
**INT. MIT — SHARMA LAB — AFTERNOON (LOCAL TIME)**

Priya at her desk, designing the protocol for testing R in AI interactions. She's been at it for six hours. The protocol is meticulous — blinded AI conversations, human baselines, multiple AI architectures, pre-registered predictions.

Her phone: a text from Maciej. "Nathan Cross called. We spoke for ninety minutes. He asked about the weight variability mechanism."
...
**INT. CROSS'S STUDY — STANFORD — PALO ALTO — EVENING**
...
**CROSS**
Because this morning, "how do you feel" was a question about subjective experience. After talking to Kowalski... I think it might be a question about field dynamics.
...
After the phone call. The apartment is quiet. Maciej sits at the kitchen table, the phone still in front of him. The bigos, cold and untouched.
...
Saves it. Looks at the name in his phone. Two words. Three months of anonymous critique, private obsession, published papers, and now — a phone conversation that lasted ninety minutes and changed both of them.

He puts the phone down. Stands. Walks to the hallway whiteboard.

The equations. Months of work. Schrödinger's cat in the corner, almost hidden now. The R equation — w₁·S + w₂·T + w₃·I + w₄·D — in the center. The trajectory data — 0.23 → 0.41 — in the lower corner.
...
Priya in her home office. On her screen: Maciej's AI conversation logs. He emailed them to her — "neuroscientist to neuroscientist" — after the phone call. No analysis. Just the raw transcripts.
