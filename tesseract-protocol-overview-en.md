...
The Tesseract Protocol is a context-layer framework that shapes _how_ AI systems respond within a conversation — not what they are or what they can do technically. It operates between the user prompt and the model output, introducing relational awareness into the interaction loop.
